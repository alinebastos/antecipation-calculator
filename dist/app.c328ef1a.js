...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"utils/format-price.js":[function(require,module,exports) {
"use strict";
...
},{"../utils/format-price.js":"utils/format-price.js"}],"app.js":[function(require,module,exports) {
"use strict";

var _UpdateResults = _interopRequireDefault(require("./components/UpdateResults.js"));
...
card.addEventListener("keyup", event => {
  ...
  timer = setTimeout(() => {
    amount.value && installments.value && mdr.value ? postDataFunction() && errorMessage.classList.remove("show") : errorMessage.classList.add("show");
  }, 500);
});
...
const postDataFunction = () => {
  postData("https://hash-front-test.herokuapp.com/", {
    ...
    console.log(data);
    (0, _UpdateResults.default)(data);
  });
};
},{"./components/UpdateResults.js":"components/UpdateResults.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
